...
import { getProfileById, useProfile } from '@/services/useProfile'
...
const logoStarbucks = '/logos/starbucks.svg'
const image1 = '/photos/image-1.jpg'
const image2 = '/photos/image-2.jpg'
const image3 = '/photos/image-3.jpg'
const image4 = '/photos/image-4.jpg'
const image5 = '/photos/image-5.jpg'
        ...
        {resume?.map((role, roleIndex) => (
          <li key={roleIndex} className="flex gap-4">
            <div className="relative mt-1 flex h-10 w-10 flex-none items-center justify-center rounded-full shadow-md shadow-zinc-800/5 ring-1 ring-zinc-900/5 dark:border dark:border-zinc-700/50 dark:bg-zinc-800 dark:ring-0">
              <Image src={role.logo} alt="" height={30} width={30} unoptimized />
            </div>
  ...
  return (
    <div className="mt-16 sm:mt-20">
      <div className="-my-4 flex justify-center gap-5 overflow-hidden py-4 sm:gap-8">
        {profile?.highlight_images?.map((image, imageIndex) => (
          <div
            key={image.href}
            className={clsx(
      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          ...
          <div className="mt-6 flex gap-6">
            {profile && profile.connects?.map((connection) => {
              return (
                <SocialLink
